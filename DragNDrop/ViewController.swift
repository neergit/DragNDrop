...
//  DragNDrop
//
//  Created by Neeraj Chandra on 06/11/17.
...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITableViewDragDelegate, UITableViewDropDelegate {
    ...
    var leftItems = [String](repeating: "Left Item", count: 5)
    var rightItems = [String](repeating: "Right Item", count: 5)
    ...
    fileprivate func setUpTableViews() {
        ...
        leftTableView.allowsMultipleSelection = true
